...
# @author Aleksander Hansen
# @Summary: Portfolio Sharpe Ratio Optimizer by adjusting allocations.
#          This version runs very, very fast!
...
def optimize(na_close, verbose=False):
    ...
    optimal_sharpe = -100
    optimal_allocation = [0.0, 0.0, 0.0, 1.0]
    optimal_vol = 0
    optimal_daily_ret = 0
    optimal_cum_ret = 0
    ...
    return optimal_sharpe, optimal_allocation, optimal_vol, optimal_daily_ret, optimal_cum_ret
...
optimal_sharpe, optimal_allocation, optimal_vol, optimal_daily_ret, optimal_cum_ret = optimize(na_close, verbose=True)
